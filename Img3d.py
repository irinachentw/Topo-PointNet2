...
if __name__ =='__main__':
    ...
    img_root = r'E:/Capstone/Code/Pointnet2data/shapenetcore_partanno_segmentation_benchmark_v0_normal/' # 数据集路径
    target_root = r'E:/Capstone/Code/Pointnet2/log/part_seg' # 输出结果路径

    num_classes = 50 # 填写数据集的类别数 如果是s3dis这里就填13   shapenet这里就填50
    choice_dataset = 'ShapNet' # 预测ShapNet数据集
    # 导入模型  部分
    ...
    model_dict = {
        'PonintNet': [model1,r'E:/Capstone/Code/Pointnet2/log/part_seg/2023-07-12_14-16/checkpointsc/best_model.pth']
        #'CSA': [model2, r'权重路径2'],
        #'PCT': [model3,r'权重路径3']
    }
